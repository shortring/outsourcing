...
public class ActivitiesController {
    ...
    // 전체 활동 로그 조회
    @GetMapping
    public ResponseEntity<ApiResponse<PagedResponse<ActivitiesResponse>>> getAllActivitiesLogApi(
    ...
    // 내 활동 로그 조회
    @GetMapping("/me")
    public ResponseEntity<ApiResponse<PagedResponse<ActivitiesAllResponse>>> getAllMyActivitiesLogApi(
        ...
        PagedResponse<ActivitiesAllResponse> result
